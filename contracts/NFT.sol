...
// File @openzeppelin/contracts/token/ERC1155/extensions/ERC1155Supply.sol@v4.5.0
...
// File contracts/SmartNodeNFT.sol
...
contract SmartNodeNFT is ERC1155, Ownable, ReentrancyGuard, Pausable, ERC1155Supply {
    ...
    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmeNHXmKJgsddKQoiBDca5Mr7irqVSJTYC98zDyFPvbQEq/";
    ...
    function uri(uint256 _id) public view override returns (string memory) {
        ...
        return bytes(baseURI).length > 0 ? string(abi.encodePacked(baseURI, (_id+1).toString(), ".json")) : "";
    }
